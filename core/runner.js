  ...
  async function runTask(task) {
      ...
      transaction(db, () => {
        ...
        dbRun(
          ...
          `UPDATE responses SET error = ?, created_at = ?, target_status = 'failed',
            ...
            reported_charge_usd = ?, reported_charge_provenance = ?,
            query_metadata_status = ?, safe_error_code = ? WHERE id = ?`,
    ...
    try {
      transaction(db, () => {
        dbRun(
          ...
          [
            ...
            costPriceVersion,
            answer.providerReportedChargeUsd ?? null,
            answer.providerReportedChargeUsd == null ? null : 'provider_reported',
            createdAt,
      ...
      dbRun(db, `UPDATE responses SET text = ?, model = ?, tokens_in = ?, tokens_out = ?,
        ...
        pricedUsage.costStatus, costPriceVersion,
        answer.providerReportedChargeUsd ?? null,
        answer.providerReportedChargeUsd == null ? null : 'provider_reported',
        createdAt,

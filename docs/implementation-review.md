...
- Limits: English rules deliberately abstain on unsupported or ambiguous claims; an ordinary-word brand can be flagged in entity setup for identity review. No live provider calls were made. C09 must connect new stance rates to the exact-series dashboard.
